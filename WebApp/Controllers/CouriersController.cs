...
namespace WebApp.Controllers
{
    public class CouriersController : Controller
    {
        ...
        public CouriersController(ExpressDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Salary,Available,Id,FirstName,LastName,Phone")] Courier courier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Salary,Available,Id,FirstName,LastName,Phone")] Courier courier)
        {
            if (id != courier.Id)
            {
                return NotFound();
